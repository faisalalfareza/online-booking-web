...
(function($){
	...
	SEMICOLON.initialize = {
		...
		goToTopScroll: function() {
			...
			// console.log("elementMobile ", elementMobile);
			// console.log("$body.hasClass('device-sm') ", $body.hasClass('device-sm'));
			// console.log("$body.hasClass('device-xs') ", $body.hasClass('device-xs'));
